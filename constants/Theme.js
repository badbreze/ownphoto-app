...
const Colors = {
    ...
    success: '#3bd555',
    disabled: '#cacaca',
    tile: 'rgba(52, 52, 52, 0.8)',
    tileTitle: 'rgba(255, 255, 255, 0.8)',
    titles: '#000000',
    toolbar: '#ffffff',
    statusbar: '#013a2a',
    ...
    secondaryForeground: '#bcbcbb',
    hintForeground: '#969696',

    background: '#ffffff',
    alterBackground: '#222835',//'#5ab9ea',
...
export const Theme = {
    ...
    colors: {
        ...
        newsListBackground: Colors.neutralBackground,
        newsItemBackground: Colors.background,
        newsItemBorder: Colors.border,
        news: {
            listBackground: Colors.neutralBackground,
            itemBackground: Colors.neutralBackground,
